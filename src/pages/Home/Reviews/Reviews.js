        ...
        <div>
            <section className="happy-client text-center my-bg-color my-5">
                <div className="container">
                    <h1 className="my-5">Our <span style={{ color: 'Blue', fontWeight: 700 }}>Visitors Says</span></h1>
                        ...
                        {reviews.map(review => <div className="col">
                            <div className="card h-100 pb-3 rounded-3 shadow py-3">
                                ...
                                <div className="card-body">
                                    <h5 className="card-title text-danger fw-bolder">{review.name}</h5>
                                    <p className="card-text">"{review.review}"</p>
                                </div>
                                <div style={{ textAlign: 'center' }}>
                                    <Rating name="half-rating-read" defaultValue={2.5} precision={review.ratings} readOnly />
                                </div>
                                <a href="#" className="text-primary fw-bold" style={{ textDecoration: "none" }}>{review.prof}</a>
