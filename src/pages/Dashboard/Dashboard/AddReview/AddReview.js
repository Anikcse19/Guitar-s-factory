...
const AddReview = () => {
    ...
    return (
        <div>
            <Typography variant='h4' style={{ color: 'Orange', fontWeight: 600, margin: '6rem' }}>Apply your satisfaction</Typography>
            {
                addReviewSuccess && <Alert severity="success">Review Added on Home page successfully!</Alert>
            }
